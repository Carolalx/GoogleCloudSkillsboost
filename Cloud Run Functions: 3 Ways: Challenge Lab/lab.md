...
**Complete com as informações fornecidas em seu lab e execute:
```bash
...
🚨 **caso resulte ERRO de Permissão, execute no terminal após 2 minutos:
```
gcloud functions deploy $FUNCTION_NAME \
  --gen2 \
  --runtime nodejs20 \
...
## 🎉 **Parabéns! Laboratório concluído com sucesso** 🏆  
