...
echo "${MAGENTA_TEXT}${UNDERLINE_TEXT}Analyzing English text...${RESET_FORMAT}"
...
echo "${YELLOW_TEXT}${UNDERLINE_TEXT}Creating multilingual text analysis request...${RESET_FORMAT}"
