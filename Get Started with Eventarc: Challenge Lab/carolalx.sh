  ...
  echo "${CYAN_TEXT}${BOLD_TEXT} INICIANDO EXECUÇÃO DO LABORATÓRIO...FIQUE ATENTO ÀS SOLICITAÇÕES ${RESET_FORMAT}"
  echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
  echo
...
echo
  ...
  echo
  echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
  echo "${CYAN_TEXT}${BOLD_TEXT}             LABORATÓRIO CONCLUIDO COM SUCESSO!        ${RESET_FORMAT}"
  echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
  echo
