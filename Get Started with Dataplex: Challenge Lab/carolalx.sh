...
echo "${CYAN_TEXT}${BOLD_TEXT}     INICIANDO EXECUÇÃO DA TASK1...    ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
...
echo
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}       EXECUÇÃO CONCLUÍDA ABRA O LINK GERADO E         ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}                SIGA PARA AS TASKs 2 e 3               ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
