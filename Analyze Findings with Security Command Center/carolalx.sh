...
echo "${GREEN_TEXT}${BOLD_TEXT}           INICIANDO EXECUÇÃO...     ${RESET_FORMAT}"
echo "${GREEN_TEXT}${BOLD_TEXT}=====================================${RESET_FORMAT}"
echo
...
echo
echo "${GREEN_TEXT}${BOLD_TEXT}====================================================================${RESET_FORMAT}"
echo "${GREEN_TEXT}${BOLD_TEXT}       EXECUÇÃO CONCLUÍDA COM SUCESSO..SIGA OS PRÓXIMOS PASSOS      ${RESET_FORMAT}"
echo "${GREEN_TEXT}${BOLD_TEXT}====================================================================${RESET_FORMAT}"
