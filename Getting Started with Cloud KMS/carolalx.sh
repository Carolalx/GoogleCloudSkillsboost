...
echo "${CYAN_TEXT}${BOLD_TEXT}                    INICIANDO EXECUÇÃO DO LABORATÓRIO             ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}   LABORATÓRIO CONCLUÍDO VERIFIQUE SEU PROGRESSO!      ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
