...
echo "${CYAN}${BOLD}   INICIANDO    ${RESET}"
echo "${CYAN}${BOLD}================${RESET}"
echo

# Get Location Input
echo "${YELLOW}${BOLD}Step 1: Informe Region conforme o lab (e.g., us-central1):${RESET}"
...
echo "${MAGENTA}${BOLD}   EXECUÇÃO COMPLETA!      ${RESET}"
echo "${MAGENTA}${BOLD}===========================${RESET}"
echo
